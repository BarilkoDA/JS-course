...
/*
Как путешествовать по DOM дереву

К примеру нужно взять определенный элемент и обратиться к его родителю или к следующему эдементу.
...
console.log(document.querySelector('[data-current="3"').previousElementSibling); // получение предыдущего узла
